...
type PatchTasksId500Response struct {
}

func (response PatchTasksId500Response) VisitPatchTasksIdResponse(w http.ResponseWriter) error {
	w.WriteHeader(500)
	return nil
}
...
type GetUsersIdTasks400Response struct {
}

func (response GetUsersIdTasks400Response) VisitGetUsersIdTasksResponse(w http.ResponseWriter) error {
	w.WriteHeader(400)
	return nil
}

type GetUsersIdTasks500Response struct {
}

func (response GetUsersIdTasks500Response) VisitGetUsersIdTasksResponse(w http.ResponseWriter) error {
	w.WriteHeader(500)
	return nil
}
